...
class Register extends Component {
  ...
  onSubmit = e => {
    ReactGA.event({
      category: "Register",
      action: "User register - English register page"
    });
    e.preventDefault();
          ...
          <div className="col s8 offset-s2">
            ...
            <div className="col s12" style={{ paddingLeft: "11.250px" }}>
              ...
              <p className="grey-text text-darken-1">
                Already have an account? <span className="click_link"><Link to="/login">Log in</Link></span>. We will not share your info in any circumstances.
              </p>
            </div>
